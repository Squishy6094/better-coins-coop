...
const GeoLayout master_cap_stage_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -3700, -7000, master_cap_stage_dl_Death_Plane_mesh_layer_5),
...
const GeoLayout master_cap_stage_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_BRANCH(1, master_cap_stage_area_1_geo),
					GEO_RENDER_OBJ(),
