...
# Modified by Agent X.
# Double Modified by Squishy for Better Coins

in_fn_id = "./skyboxes/pink_cloud_sky.png"
tile_count = 64
...
for i in range(tile_count):
    ...
    in_img.crop((
        ...
        )).save(f"{os.path.basename(in_fn_id).split('.')[0]}.{f'{i:02}'}.png", "PNG", optimize=True)
    print("Finished Tile " + str(i))
